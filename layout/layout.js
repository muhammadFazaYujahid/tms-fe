...
const Layout = (props) => {
    const { layoutConfig, layoutState, setLayoutState, showSidebar, setShowSidebar, setNewNotification } = useContext(LayoutContext);
    ...
    useEffect(() => {
        socket.on('receiveNotif', (messageData) => {
            setNewNotification(true);
            emit('refreshBacklog');
            emit('getNewNotification', messageData);
        })
    ...
    return (
        <React.Fragment>
            ...
            <div className={containerClass}>
                ...
                <div className={showSidebar == false ? ("ml-5 layout-main-container") : ("layout-main-container")}>
