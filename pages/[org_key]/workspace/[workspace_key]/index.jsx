...
const Dashboard = ({ myQuery }) => {
    ...
    const showInviteDialog = () => {
        ...
        setDialogType(<InviteWorkspace registedMember={members} />);
            ...
            command: () => {
                ...
                const showContent = (
                    <div className="flex flex-column align-items-center" style={{ flex: '1' }}>
                        ...
                        <div className="flex gap-2">
                            <Button onClick={(e) => clear(false)} type="button" label="Cancel" className="p-button-info w-6rem" />
                            <Button onClick={(e) => deleteWorkspace(sessionStorage.getItem('work_key'))} type="button" label="Delete" className="p-button-danger w-6rem" />
                        </div>
                    </div>
                )
                show(showContent, severity);
        ...
        <div className="grid">
            ...
            <div className='col-12 mt-4'>
                <div className='grid'>
                    ...
                    <Dialog header={dialogHeader} maskStyle={maskStyles} visible={contentDialog} className='p-dialog' style={{ backgroundColor: "#fff" }} modal onHide={() => setContentDialog(false)}>
                        {dialogType}
                    </Dialog>
                                                                ...
                                                                <div className='col'>
                                                                    {
                                                                        team.workspace_members.map((member) => (
                                                                            ...
                                                                            <Avatar className='mx-2' image={contextPath + '/demo/images/avatar/default-photo.png'} size="large" shape="circle"></Avatar>
                                                                        ))
                                                                    }
                                                                </div>
                                                            </div>
